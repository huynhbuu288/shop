                    ...
                    <div class="position-center">
                       ...
                       {{ csrf_field() }}
                        ...
                        <div class="form-group">
                            ...
                            <input product="text" value="{{$pro->product_price}}"  name="product_price"  class="form-control" 
                        ...
                        <div class="form-group">
                            ...
                            id="exampleInputPassword1"> {{$pro->product_desc}}
                            </textarea>
                        </div>
                        <div class="form-group">
                            <label for="exampleInputPassword1">Nội Dung Sản Phẩm</label>
                            <textarea  class="form-control" name="product_content" 
                            id="exampleInputPassword1">{{$pro->product_content}}
                            </textarea>
                        </div>
                        <div class="form-group">
                        ...
                        <button product="submit" name="add_product" class="btn btn-info">Cập Nhật Sản Phẩm</button>
                      </form>
                      @endforeach
                    </div>
