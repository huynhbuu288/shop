...
<div class="product-details"><!--product-details-->
              ...
              <!-- Wrapper for slides -->
                <div class="carousel-inner">
                    <div class="item active">
                      <a href=""><img src="{{asset('/assets/images/similar1.jpg')}}" alt=""></a>
                      <a href=""><img src="{{asset('/assets/images/similar2.jpg')}}" alt=""></a>
                      <a href=""><img src="{{asset('/assets/images/similar3.jpg')}}" alt=""></a>
                    </div>
    ...
    <div class="col-sm-7">
        <div class="product-information"><!--/product-information-->
            ...
            <a href=""><img src="{{asset('assets/images/share.png')}}" class="share img-responsive"  alt="" /></a>
        ...
        <div class="tab-pane fade" id="reviews" >
            <div class="col-sm-12">
                ...
                <form action="#">
                    ...
                    <b>Rating: </b> <img src="{{asset('assets/images/rating.png')}}" alt="" />
